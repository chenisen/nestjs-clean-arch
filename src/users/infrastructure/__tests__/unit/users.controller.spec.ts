...
describe('UsersController unit tests', () => {
  ...
  it('should create a user', async () => {
    ...
    sut['signupUseCase'] = mockSignupUseCase;
  ...
  it('should authenticate a user', async () => {
    ...
    sut['signinUseCase'] = mockSigninUseCase;
  ...
  it('should update a user', async () => {
    ...
    sut['updateUserUseCase'] = mockUpdateUserUseCase;
  ...
  it('should update a users password', async () => {
    ...
    sut['updatePasswordUseCase'] = mockUpdatePasswordUseCase;
  ...
  it('should delete a user', async () => {
    ...
    sut['deleteUserUseCase'] = mockDeleteUserUseCase;
  ...
  it('should gets a user', async () => {
    ...
    sut['getUserUseCase'] = mockGetUserUseCase;
  ...
  it('should list users', async () => {
    ...
    sut['listUsersUseCase'] = mockListUsersUseCase;
    const searchParams = {
      page: 1,
      perPage: 1,
    };
